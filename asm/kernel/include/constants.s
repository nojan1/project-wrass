...
GRAPHICS_ADDR_TILEDATA_HIGH = $40

GRAPHICS_ADDR_COLORS_LOW = $00
GRAPHICS_ADDR_COLORS_HIGH = $48

;; System VIA PORTA fields
SPI_CLOCK = 1 << 3
SPI_CLOCK_INVERT = 1 << 4
SPI_DATA_LATCHB = 1 << 5
SPI_OEB = 1 << 6
KEYBOARD_OEB = 1 << 7
...
CLOCK_INVERT = 1 << 4
CLOCK_NON_INVERT = 0 << 4

SPI_MODE_0 = CLOCK_LOW | CLOCK_INVERT
SPI_MODE_1 = CLOCK_LOW | CLOCK_NON_INVERT
SPI_MODE_2 = CLOCK_HIGH | CLOCK_NON_INVERT
SPI_MODE_3 = CLOCK_HIGH | CLOCK_INVERT

; Probably not used any more
SPI_SLOWCLOCK = 2
SPI_FASTERCLOCK = 1

; SPI disabled is the same as "device 0"
SPI_DEVICES_DISABLED = 0
SPI_DEVICE_1 = 1 
SPI_DEVICE_2 = 2 
SPI_DEVICE_3 = 3 
SPI_DEVICE_4 = 4 
...
;;; SD CARD
SD_CARD_SPI_DEVICE = SPI_DEVICE_1 | SPI_MODE_0

SD_CARD_NOT_INITIALIZED = 0
SD_CARD_INITIALIZED = 1
SD_CARD_ERRORED = 2

;;; Filesystem

FILE_HANDLE_STATUS_OPENED = 1
FILE_HANDLE_STATUS_EOF = 2
