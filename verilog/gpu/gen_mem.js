...
// Put the entire charset on screen
let colorIndex = 1;
[...new Array(256).fill(0)].forEach((_, i) => {
  if (i === 128) colorIndex = 1;
  const colorAttribute = ((colorIndex << 4) | 0) & 0xff;
  if (++colorIndex > 15) colorIndex = 1;

  tile_memory[FramebufferStart + i] = i;
  attribute_memory[ColorAttributesStart + i] = colorAttribute;

  expectedTileIds.push(i);
  expectedColorAttributes.push(colorAttribute);
});
